    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 gap-5">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-indigo-600 text-white px-6 py-3 rounded-2xl font-bold text-sm shadow-lg shadow-indigo-200 active:bg-indigo-700"
        >
          <Sparkles size={16} />
          AI 주간 배분 생성
        </button>
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex gap-2">
          <button
            onClick={handleGenerate}
            className="flex items-center gap-1 text-xs text-indigo-600 bg-indigo-50 px-3 py-1.5 rounded-xl font-semibold"
          >
